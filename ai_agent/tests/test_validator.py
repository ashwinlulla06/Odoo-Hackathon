...
def test_validator_rejects_clashing_time_slots():
    stops = [{"id":"s1","city_id":"delhi","start_date":"2026-09-01","end_date":"2026-09-01"}]
    activities = [
        {"id":"a1","city_id":"delhi","name":"Museum","cost":20,"duration_hours":3},
        {"id":"a2","city_id":"delhi","name":"Food walk","cost":30,"duration_hours":2},
    ]
    items = [
        ProposalItem(stop_id="s1", activity_id="a1", name="Museum", day_index=1, time_slot="10:00", cost=20),
        ProposalItem(stop_id="s1", activity_id="a2", name="Food walk", day_index=1, time_slot="11:00", cost=30),
    ]
    assert any("overlaps" in error for error in validate_proposal(_proposal(items, 50), stops, activities))
